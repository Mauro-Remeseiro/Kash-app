...
class _LockScreenState extends State<LockScreen> with TickerProviderStateMixin {
  ...
  Future<void> _verify() async {
    ...
    if (result.locked) {
      ...
      setState(() => _errorText = l10n.bloqueadoSegundos(result.lockedSeconds ?? 30));
    } else {
      setState(() => _errorText = l10n.pinIncorrecto);
      // Desaparece en 1.5s
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(l10n.separadorO, style: const TextStyle(color: _subTitle, fontSize: 14)),
                        const SizedBox(height: 20),
                        // ── PIN circles ────────────────────────────────
                        AnimatedBuilder(
                        ...
                        SizedBox(
                          ...
                          child: AnimatedSwitcher(
                            ...
                            child: _lockSeconds > 0
                                ? Text(
                                    l10n.bloqueadoSegundos(_lockSeconds),
